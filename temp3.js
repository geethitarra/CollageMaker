...
window.addEventListener('load', () => {
    ...
    const color = localStorage.getItem('favoriteColor');
            ...
            if (bColor == 1){
                ...
                document.body.style.backgroundImage = "url('red.jpeg')";
            }

            else if (bColor == 2){
                
                document.body.style.backgroundImage = "url('green.jpeg')";
            }

            else if (bColor == 3){
                
                document.body.style.backgroundImage = "url('blue.jpeg')";                
            }

            else  if (bColor == 4){
               
                document.body.style.backgroundImage = "url('purple.jpeg')";
            }

            else if (bColor == 5){
               
                document.body.style.backgroundImage = "url('pink.jpeg')";
            }

            else if (bColor == 6){
        
                document.body.style.backgroundImage = "url('yellow.jpeg')";
            }

            else if (bColor == 7){
        
                document.body.style.backgroundImage = "url('orange.jpeg')";
            }
